...
/**
 * The Class ShareToClipboardApplication is the host for the GDListActivity.
 */
public class ShareToClipboardApplication extends GDApplication {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see greendroid.app.GDApplication#getHomeActivityClass()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see greendroid.app.GDApplication#getMainApplicationIntent()
	 */
	@Override
